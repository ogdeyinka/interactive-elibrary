...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'picEdit',
        defaults = {
			...
			afterFormSubmitted:function(res){}, // After form was submitted callback function
			...
			redirectUrl: true,				// Page url for redirect on form submit
	...
	Plugin.prototype = {
		...
		_formsubmit: function() {
			...
			if(!this._image) this.set_messagebox("No image is loaded! Try and load an image");
			else {
				var _this = this;
				this.set_loading().delay(200).promise().done(function() {
					...
					_this.options.afterFormSubmitted(this);
				});
			}
			return false;
		},
